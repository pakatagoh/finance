...
func (r createRequest) input() (storage.TransactionInput, bool) {
	...
	if !oneOf(r.TimestampSource, "transaction", "email_received", "inferred") || !oneOf(r.Kind, "card_purchase", "paynow", "funds_transfer", "incoming_transfer", "reversal") || !oneOf(r.Direction, "debit", "credit") {
		return storage.TransactionInput{}, false
	}
